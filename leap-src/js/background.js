/**
 * @file Leap motion chrome extension background page. It has a messaging
 * listener to handle switching tabs and zooming.
  ...
  if (request.tab_direction) {
    ...
    chrome.tabs.query({currentWindow: true}, function(tabs) {
      ...
      if (request.tab_direction === 'right') {
        ...
        switchToTab = (activeTabIndex - 1) % tabsCount;
        if (switchToTab === -1) switchToTab = tabsCount - 1;
